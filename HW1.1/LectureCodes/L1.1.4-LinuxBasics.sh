...
# Instead of running this side by side with terminal, I selected each chunk of code in VSCode and clicked on "Run in Terminal"
# The terminal had trouble with the .py files where I added %matplotlib widget to run the interactive plots in VSCode
# Will ask prof Hickman during OH